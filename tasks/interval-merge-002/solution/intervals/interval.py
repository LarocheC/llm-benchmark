...
class Interval:
    ...
    def connects(self, other):
        ...
        they overlap, touch at a shared endpoint, or are immediately adjacent
        with no integer separating them -- i.e. whenever ``other`` starts no
        more than one unit past this interval's end.
        """
        return self.reaches(other) <= 1
