...
from .distribute import even_parts, distribute_remainder
...
def split_amount(total_cents, n):
    ...
    # The leftover cents recorded in the quota must be handed out, otherwise the
    # parts sum to less than the total and cents go missing.
    distribute_remainder(parts, quota.remainder)
